Feel free to use any code you find useful! All assets...the flower and the vine were made by me in Affinity!
...
For backend:
  ...
  CLoudinary -> for picture compression without fidelity loss

Hosts:

  frontend host = Netlify
  
  backend/database host = Railway
